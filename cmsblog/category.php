...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                try {
                    ...
                    <hr>
                    <a href='post.php?post_id=$p->postID'><img class='img-responsive' src='images/posts/$p->postName/$p->postImage' alt='$p->postImage'></a>
                    <hr>
        ...
        <ul class="pager">
            <?php
            try {
                $pNums = Post::pageination(ITEM_PER_PAGE, $catID);

                foreach ($pNums as $pNo => $start) {
                    echo "<li><a href='" . BASE_URL . "category.php?start=$start&cat_id=$catID'>$pNo</a> </li>";
                }
            } catch (Exception $ex) {
                echo ($ex->getMessage());
            }
